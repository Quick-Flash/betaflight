...
static const OSD_Entry cmsx_menuRateProfileEntries[] =
{
    ...
    { "R TAU CEN",     OME_UINT8,  NULL, &(OSD_UINT8_t) { &rateProfile.rc_smoothing_setpoint_tau_center[FD_ROLL],  0,  255,  1} },
    { "R TAU END",     OME_UINT8,  NULL, &(OSD_UINT8_t) { &rateProfile.rc_smoothing_setpoint_tau_end[FD_ROLL],     0,  255,  1} },
    { "P TAU CEN",     OME_UINT8,  NULL, &(OSD_UINT8_t) { &rateProfile.rc_smoothing_setpoint_tau_center[FD_PITCH], 0,  255,  1} },
    { "P TAU END",     OME_UINT8,  NULL, &(OSD_UINT8_t) { &rateProfile.rc_smoothing_setpoint_tau_end[FD_PITCH],    0,  255,  1} },
    { "Y TAU CEN",     OME_UINT8,  NULL, &(OSD_UINT8_t) { &rateProfile.rc_smoothing_setpoint_tau_center[FD_YAW],   0,  255,  1} },
    { "Y TAU END",     OME_UINT8,  NULL, &(OSD_UINT8_t) { &rateProfile.rc_smoothing_setpoint_tau_end[FD_YAW],      0,  255,  1} },
