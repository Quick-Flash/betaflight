...
const char * const debugModeNames[DEBUG_COUNT] = {
    ...
    [DEBUG_EZLANDING] = "WAS_EZLAND", // ezland removed
    [DEBUG_TPA] = "TPA",
    [DEBUG_S_TERM] = "S_TERM",
    [DEBUG_SPA] = "SPA",
    [DEBUG_TASK] = "TASK",
    ...
    [DEBUG_CHIRP] = "CHIRP",
    [DEBUG_BUFFER_1] = "EMPTY_1",
    [DEBUG_BUFFER_2] = "EMPTY_2",
    [DEBUG_BUFFER_3] = "EMPTY_3",
    [DEBUG_ALTHOLD] = "ALTHOLD", // TODO remove later
    [DEBUG_CG_COMPENSATION] = "CG_COMPENSATION",
    [DEBUG_COLLISION_DETECTION] = "COLLISION_DETECTION",
    [DEBUG_SOFT_ARM] = "SOFT_ARM",
};
